...
# ---- CSS: dreamy script for both subtitle/privacy, NO cursor tracking, EQUAL FONT SIZE ----
st.markdown("""
    <style>
        body, .stApp {
        ...
        /* Dreamy script font for subtitle/privacy lines, equal size */
...
# Dreamy script, no outline subtitle/privacy lines, equal size
st.markdown("""
